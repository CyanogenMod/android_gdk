...
# -----------------------------------------------------------------------------
# Template  : ev-compile-c-source-to-bitcode
# Arguments : 1: single C source file name (relative to LOCAL_PATH)
#             2: target bc file (without path)
# Returns   : None
# Usage     : $(eval $(call ev-compile-c-source,<srcfile>,<bcfile>)
# Rationale : Internal template evaluated by compile-c-source-to-bitcode
# -----------------------------------------------------------------------------
define  ev-compile-c-source-to-bitcode
_SRC:=$$(LOCAL_PATH)/$(1)
...
# -----------------------------------------------------------------------------
# Function  : compile-c-source-to-bitcode
# Arguments : 1: single C source file name (relative to LOCAL_PATH)
# Returns   : None
# Usage     : $(call compile-c-source,<srcfile>)
# Rationale : Setup everything required to build a single C source file
# -----------------------------------------------------------------------------
compile-c-source-to-bitcode = $(eval $(call ev-compile-c-source-to-bitcode,$1,$(1:%.c=%.bc)))
...
# bitcode libraries:
# <foo> -> lib<foo>.bc by default
# a bitcode library is installable.
