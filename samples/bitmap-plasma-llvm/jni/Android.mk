...
include $(CLEAR_VARS)
ROOT := /usr/local/google/work/m/

LOCAL_MODULE    := plasma_portable

LOCAL_CFLAGS := -I $(ROOT)/frameworks/compile/libbcc/include/ \
  -I $(ROOT)/external/clang/lib/Headers/ \
  -I ../../platforms/android-100/arch-arm/usr/include/ 
